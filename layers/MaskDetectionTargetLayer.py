...
def detection_targets_graph(proposals, gt_class_ids, gt_boxes, gt_masks, config):
    ...
    # them fro training. A crowd box is given a negetive class ID.
...
class MaskDetectionTargetLayer(keras.layers.Layer):
    ...
    def __init__(self, config, **kwargs):
        super(MaskDetectionTargetLayer, self).__init__(**kwargs)
        self.config = config

    def get_config(self):
        config = super(MaskDetectionTargetLayer, self).get_config()
    ...
    def call(self, inputs):
        ...
        names = ["mask_rois", "target_class_ids", "mask_target_deltas", "target_mask", "target_mask_scores"]
    ...
    def compute_output_shape(self, input_shape):
        return [
            ...
            (None, self.config.TRAIN_ROIS_PER_IMAGE),  # gt_class_ids
